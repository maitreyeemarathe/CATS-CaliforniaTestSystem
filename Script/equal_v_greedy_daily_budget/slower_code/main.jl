...
include(joinpath(CATS_DIR, "build_CATS_2025.jl"))
...
shasta_csv = joinpath(HYDRO_DATA_DIR, "shasta_hourly_2025.csv")
devilcanyon_csv = joinpath(HYDRO_DATA_DIR, "devilcanyon_hourly_2025.csv")
mammoth_csv = joinpath(HYDRO_DATA_DIR, "mammoth_hourly_2025.csv")
...
for week_i in 1:52
    start_time = DateTime("2025-10-01T00:00:00") + Week(week_i - 1)
    if start_time == DateTime("2025-10-29T00:00:00")
        println("Skipping week starting on $start_time due infeasibility.")
        continue
    end
